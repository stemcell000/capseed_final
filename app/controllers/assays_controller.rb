  ...
  private
   ...
   def sort_column_by_name
    ...
    def assay_params
      ...
      :clone_batches_attributes => [:id, :name, :temp_name, :comment, :plasmid_validation, :strict_validation, :assay_id, :_destroy, :strand_id, :type_id, :date_as_plasmid, :glyc_stock_box_as_plasmid, :comment_as_plasmid, :qc_validation,
