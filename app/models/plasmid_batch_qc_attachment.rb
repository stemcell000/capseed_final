class PlasmidBatchQcAttachment < ActiveRecord::Base
mount_uploader :attachment, AttachmentUploader
 
 belongs_to :plasmid_batch_qc
 ...
 after_save { |plasmid_batch_qc_attachment| plasmid_batch_qc_attachment.destroy if plasmid_batch_qc_attachment.attachment.blank? }
